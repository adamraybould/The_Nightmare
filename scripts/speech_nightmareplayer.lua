return {
	...
	ANNOUNCE_BEES = "Not the bees!",
	ANNOUNCE_BOOMERANG = "Ow! I should try to catch that next time!",
	ANNOUNCE_CHARLIE = "I can hear you Charlie",
	ANNOUNCE_CHARLIE_ATTACK = "Charlie get off me!",
	ANNOUNCE_COLD = "I hate the cold",
	ANNOUNCE_HOT = "Hot! Hot! Hot!",
	ANNOUNCE_CRAFTING_FAIL = "You must acquire additional ingredients",
	ANNOUNCE_DEERCLOPS = "I sense...something big",
	ANNOUNCE_DUSK = "My time soon comes",
	ANNOUNCE_EAT =
	{
		GENERIC = "That was nice",
		PAINFUL = "Yum",
		SPOILED = "Why did i eat that!?",
		STALE = "Where the best before date?",
		INVALID = "This is not food",
	},
	ANNOUNCE_ENTER_DARK = "I'm not afraid",
	ANNOUNCE_ENTER_LIGHT = "The light!!",
	ANNOUNCE_FREEDOM = "I'm free! I'm finally free!",
	ANNOUNCE_HIGHRESEARCH = "My brain grows!!",
	ANNOUNCE_HOUNDS = "Evil is coming",
	ANNOUNCE_HUNGRY = "FEEEEEEEED MEEEEEEEEEEEEEE",
	ANNOUNCE_HUNT_BEAST_NEARBY = "This beast seems to be nearby",
	ANNOUNCE_HUNT_LOST_TRAIL = "The trail ends here.",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "The wet ground won't hold a footprint.",
	ANNOUNCE_INV_FULL = "I am limited to what i can carry",
	...
	ANNOUNCE_NOHUNGERSLEEP = "I'm too hungry to sleep, so FEED ME",
	...
	ANNOUNCE_ACCOMPLISHMENT_DONE = "Look what i did!",	
	ANNOUNCE_INSUFFICIENTFERTILIZER = "Are you still hungry, plant?",
	ANNOUNCE_TOOL_SLIP = "Wow that tool is slippery!",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "Safe from that lightning!",

	ANNOUNCE_DAMP = "H2O.",
	ANNOUNCE_WET = "I appear to be wet.",
	ANNOUNCE_WETTER = "Water way to go!",
	ANNOUNCE_SOAKED = "I've nearly reached my saturation point.",
	
	ANNOUNCE_MAXPETS = "I've Reached my Limit..",
	ANNOUNCE_SHADOWWRONGITEM = "I don't think It will accept that",

	BATTLECRY =
	{
		GENERIC = "ATTACK!!",
		PIG = "Die Pie!",
		PREY = "I will sent you to the shadow realm!",
		SPIDER = "Kill it!",
		SPIDER_WARRIOR = "A warrior? ha!!",
	},
	COMBAT_QUIT =
	{
		...
		PREY = "He's too fast!",
		SPIDER = "Waste of time",
		SPIDER_WARRIOR = "The battle is lost",
	},
	DESCRIBE =
	{
        GLOMMER = "What are you??",
        GLOMMERFLOWER = 
        {
		...
		HOUNDSTOOTH="It could be used for... something.",
